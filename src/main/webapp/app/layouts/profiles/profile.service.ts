...
import { SERVER_API_URL, USER_MANAGEMENT_SERVER_API_URL } from 'app/app.constants';
...
export class ProfileService {
    ...
    checkForValidIP(data: any): Observable<any> {
        return this.http.post(SERVER_API_URL + 'api/home/ipCheck', data);
    }
}
