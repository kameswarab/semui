...
describe('administration', () => {
    ...
    it('should load metrics', async () => {
        ...
        const value1 = await element(by.id('metrics-cri-main-heading')).getText();
    ...
    it('should load health', async () => {
        ...
        const value1 = await element(by.id('health-cri-main-heading')).getText();
        expect(value1).to.eq(expect1);
    });
    ...
    it('should load configuration', async () => {
        ...
        const value1 = await element(by.id('configuration-cri-main-heading')).getText();
        expect(value1).to.eq(expect1);
    });
    ...
    it('should load audits', async () => {
        ...
        const value1 = await element(by.id('audits-cri-main-heading')).getText();
        expect(value1).to.eq(expect1);
    });
    ...
    it('should load logs', async () => {
        ...
        await browser.sleep(500);
        const expect1 = 'Logs';
        const value1 = await element(by.id('logs-cri-main-heading')).getText();
        expect(value1).to.eq(expect1);
    });
